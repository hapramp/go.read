        ...
        <section className={`form sm:mt-10`}>
          <div
            ...
            <div className="mt-6 sm:mt-10">
              <a href="https://play.google.com/store/apps/details?id=com.go.social" className="text-white hover:text-white shadow sm:shadow-none mt-4 md:mt-0 flex-grow bg-primary p-3 sm:py-4 sm:px-6 rounded cursor-pointer" target="__new">
