      ...
      <div
        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
            <h2 className="font-black text-4xl lg:text-4xl italic leading-tight">Streaks are a fun way to learn</h2>
            <div className="mt-10">
              {/* Badge 1 */}
              <div className="flex flex-row items-center">
                <img className="h-16 w-16" src={badge1} alt="Badge"/>
                <div className="ml-4">
                  <h5 className="text-xl uppercase font-bold">1 to 5 Days - Trial</h5>
                  <p className="text-lg">Trying out that idea</p>
                </div>
              </div>
              ...
              <div className="flex flex-row items-center mt-6">
                ...
                <div className="ml-4">
                  <h5 className="text-xl uppercase font-bold">7 to 15 Days - Experiment</h5>
                  <p className="text-lg">Experimenting with the idea</p>
                </div>
              </div>
              ...
              <div className="flex flex-row items-center mt-6">
                ...
                <div className="ml-4">
                  <h5 className="text-xl uppercase font-bold">30 Day - Learning</h5>
                  <p className="text-lg">From 20-hour learning rule (45 mins * 30 days)</p>
                </div>
              </div>
              ...
              <div className="flex flex-row items-center mt-6">
                ...
                <div className="ml-4">
                  <h5 className="text-xl uppercase font-bold">180 Days - Master</h5>
                  <p className="text-lg">Get disciplined and master the art</p>
                </div>
              </div>
              ...
              <div className="flex flex-row items-center mt-6">
                ...
                <div className="ml-4">
                  <h5 className="text-xl uppercase font-bold">365 Days - Legend</h5>
        ...
        <div
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
            <h2 className="font-black text-4xl lg:text-4xl italic leading-tight">Rewards That Keep You Going!</h2>
            ...
            <div className="inline-block mt-8 text-primary border-b-2 uppercase">
              <Link to="/tags/contests/">Explore Contests</Link>
            </div>
          </div>
          <div className="md:w-1/2">
